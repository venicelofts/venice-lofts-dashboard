...
2. **[Azure configuration](azure.md)** — Microsoft sign-in; Graph mail for local scan
...
| Local scanner (`pnpm scan`, Graph mail / PDF folders) | Works         | [first-scan](first-scan.md)                          |
